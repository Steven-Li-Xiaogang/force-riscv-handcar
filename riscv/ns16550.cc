...
std::string ns16550_generate_dts(const simif_t* sim)
{
  std::stringstream s;
  s << std::hex
...
ns16550_t* ns16550_parse_from_fdt(const void* fdt, const simif_t* sim, reg_t* base, const std::vector<std::string>& sargs)
{
